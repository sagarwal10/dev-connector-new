...
// when you use withRouter in connect line at the end, history automatically
// gets passed in as a property
const AddExperience = ({addExperience, history})  => {
  ...
  // this variable is used to disable the "To" Date field in case current
  // is checked
