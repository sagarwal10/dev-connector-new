...
// history object is used to redirect user to dashboard after
// profile is created is part of the props because we inclduded withRouter
// createProfile action is also used to edit profile
const EditProfile = ({profile: {profile, loading}, 
                 createProfile, 
		 getCurrentProfile, 
	         history}) => {
  // useState takes in data for initial state and returns
  // the initial state and a funtion to set the state later on
  ...
  // use react hooks to load the profile as soon as this component is mounted
  // and then fill in the form data from the what get current profile returned
  useEffect(() => {
    getCurrentProfile();
    
    // Fill in the form data from the current profile to make it easier 
    // for editing
    setFormData({
